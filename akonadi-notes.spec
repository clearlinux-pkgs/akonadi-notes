...
Version  : 24.08.3
Release  : 79
URL      : https://download.kde.org/stable/release-service/24.08.3/src/akonadi-notes-24.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.3/src/akonadi-notes-24.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.3/src/akonadi-notes-24.08.3.tar.xz.sig
...
%setup -q -n akonadi-notes-24.08.3
cd %{_builddir}/akonadi-notes-24.08.3
pushd ..
cp -a akonadi-notes-24.08.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745341665
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-notes-%{version}/readme-build-ftime.txt.license %{buildroot}/usr/share/package-licenses/akonadi-notes/cadc9e08cb956c041f87922de84b9206d9bbffb2 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiNotes.so.6.2.3
/usr/lib64/libKPim6AkonadiNotes.so.6
/usr/lib64/libKPim6AkonadiNotes.so.6.2.3
