...
Version  : 18.12.2
Release  : 2
URL      : https://download.kde.org/stable/applications/18.12.2/src/akonadi-notes-18.12.2.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.2/src/akonadi-notes-18.12.2.tar.xz
...
%prep
%setup -q -n akonadi-notes-18.12.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1549857977
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5AkonadiNotes.so.5.10.2
