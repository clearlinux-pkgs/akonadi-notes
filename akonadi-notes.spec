...
Version  : 23.08.1
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.08.1/src/akonadi-notes-23.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/akonadi-notes-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/akonadi-notes-23.08.1.tar.xz.sig
...
%prep
%setup -q -n akonadi-notes-23.08.1
cd %{_builddir}/akonadi-notes-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695087170
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5AkonadiNotes.so.5.24.1
/usr/lib64/libKPim5AkonadiNotes.so.5
/usr/lib64/libKPim5AkonadiNotes.so.5.24.1
