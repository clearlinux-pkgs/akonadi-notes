...
Version  : 23.08.5
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.5/src/akonadi-notes-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/akonadi-notes-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/akonadi-notes-23.08.5.tar.xz.sig
...
%prep
%setup -q -n akonadi-notes-23.08.5
cd %{_builddir}/akonadi-notes-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708410386
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5AkonadiNotes.so.5.24.5
/usr/lib64/libKPim5AkonadiNotes.so.5
/usr/lib64/libKPim5AkonadiNotes.so.5.24.5
