...
Version  : 21.08.2
Release  : 32
URL      : https://download.kde.org/stable/release-service/21.08.2/src/akonadi-notes-21.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/akonadi-notes-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/akonadi-notes-21.08.2.tar.xz.sig
...
%prep
%setup -q -n akonadi-notes-21.08.2
cd %{_builddir}/akonadi-notes-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634392168
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-notes-21.08.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/akonadi-notes/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/akonadi-notes-21.08.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/akonadi-notes/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/akonadi-notes-21.08.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-notes/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/akonadi-notes-21.08.2/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/akonadi-notes/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiNotes.so.5.18.2
