...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/akonadi-notes-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/akonadi-notes-23.08.3.tar.xz.sig
...
%prep
%setup -q -n akonadi-notes-23.08.3
cd %{_builddir}/akonadi-notes-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701931291
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5AkonadiNotes.so.5.24.3
/usr/lib64/libKPim5AkonadiNotes.so.5
/usr/lib64/libKPim5AkonadiNotes.so.5.24.3
