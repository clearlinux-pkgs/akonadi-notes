...
Version  : 23.04.3
Release  : 56
URL      : https://download.kde.org/stable/release-service/23.04.3/src/akonadi-notes-23.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/akonadi-notes-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/akonadi-notes-23.04.3.tar.xz.sig
...
%prep
%setup -q -n akonadi-notes-23.04.3
cd %{_builddir}/akonadi-notes-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688862342
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5AkonadiNotes.so.5.23.3
/usr/lib64/libKPim5AkonadiNotes.so.5
/usr/lib64/libKPim5AkonadiNotes.so.5.23.3
