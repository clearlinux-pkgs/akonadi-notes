...
Version  : 20.12.1
Release  : 27
URL      : https://download.kde.org/stable/release-service/20.12.1/src/akonadi-notes-20.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/akonadi-notes-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/akonadi-notes-20.12.1.tar.xz.sig
...
%prep
%setup -q -n akonadi-notes-20.12.1
cd %{_builddir}/akonadi-notes-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610046102
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-notes-20.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-notes/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiNotes.so.5.16.1
