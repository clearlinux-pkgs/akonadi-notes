...
Version  : 22.12.0
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.12.0/src/akonadi-notes-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/akonadi-notes-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/akonadi-notes-22.12.0.tar.xz.sig
...
%prep
%setup -q -n akonadi-notes-22.12.0
cd %{_builddir}/akonadi-notes-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670537494
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiNotes.so.5.22.0
