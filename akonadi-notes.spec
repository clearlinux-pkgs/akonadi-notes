...
Version  : 24.05.2
Release  : 71
URL      : https://download.kde.org/stable/release-service/24.05.2/src/akonadi-notes-24.05.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/akonadi-notes-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/akonadi-notes-24.05.2.tar.xz.sig
...
%setup -q -n akonadi-notes-24.05.2
cd %{_builddir}/akonadi-notes-24.05.2
pushd ..
cp -a akonadi-notes-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720588496
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiNotes.so.6.1.2
/usr/lib64/libKPim6AkonadiNotes.so.6
/usr/lib64/libKPim6AkonadiNotes.so.6.1.2
