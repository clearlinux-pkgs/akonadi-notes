...
%setup -q -n akonadi-notes-24.08.2
cd %{_builddir}/akonadi-notes-24.08.2
pushd ..
cp -a akonadi-notes-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728611477
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiNotes.so.6.2.2
/usr/lib64/libKPim6AkonadiNotes.so.6
/usr/lib64/libKPim6AkonadiNotes.so.6.2.2
